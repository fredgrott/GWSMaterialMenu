...
import com.github.shareme.gwsmaterialmenu.library.MaterialMenu;
import com.github.shareme.gwsmaterialmenu.library.MaterialMenuDrawable;
import com.github.shareme.gwsmaterialmenu.library.MaterialMenuView;
...
public class BaseActivityHelper implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    public void refreshDrawerState() {
        //org code author missed that it needs to be GravityCompat.START
